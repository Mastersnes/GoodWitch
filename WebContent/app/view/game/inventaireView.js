...
function($, _, page) {
	...
	return function(parent) {
		...
		this.makeEvents = function() {
			var that = this;
			$("inventaire item").off("click");
			$("inventaire item").on("click", function() {
			...
			$("inventaire mask, inventaire .close").off("click");
			$("inventaire mask, inventaire .close").on("click", function() {
				$(that.el).hide();
			});
		};
